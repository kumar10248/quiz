      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4">
            <Link href="/" className="bg-gray-800 hover:bg-gray-700 text-white py-3 px-6 rounded-lg flex items-center justify-center">
              <FaHome className="mr-2" /> Home
            </Link>
            <Link href="/practice" className="bg-gray-800 hover:bg-gray-700 text-white py-3 px-6 rounded-lg flex items-center justify-center">
              <FaArrowLeft className="mr-2" /> Choose Another Practice
            </Link>
            <Link href={`/practice/${mode}`} className="bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 px-6 rounded-lg flex items-center justify-center">
